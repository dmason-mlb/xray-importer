...
class XrayDecoratorAdder:
                ...
                if test_id:
                    ...
                    if jira_key:
                        ...
                        if not xray_exists:
                            ...
                            # Add the xray decorator with JIRA issue key
    ...
    def process_file(self, file_path):
        ...
        try:
            ...
            if modified:
                ...
                print(f"  ✓ Updated with {self.tests_updated - (self.tests_updated - modified)} Xray decorators")
    ...
    def save_report(self):
        ...
        report_file = Path(__file__).parent.parent / "logs" / f"xray_decorator_final_report_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
